...
class SalesModel
{
    static public function showSales($table, $item, $value)
    {
        if ($item != null) {
    ...
    static public function editSale($table, $data)
    {
    ...
    static public function deleteSale($table, $data)
    {
    ...
    static public function salesDatesRange($table, $initialDate, $finalDate)
    {
        if ($initialDate == null) {
            $stmt = Connection::connect()->prepare("SELECT * FROM $table ORDER BY id ASC");
            $stmt->execute();
    ...
    static public function addingTotalSales($table)
    {
